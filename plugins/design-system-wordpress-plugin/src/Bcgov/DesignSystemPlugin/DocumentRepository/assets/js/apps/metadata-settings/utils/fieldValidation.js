 ...
 * @returns {string} [errors.id] - Error message for ID validation
 * @returns {string} [errors.label] - Error message for label validation
 * @returns {string} [errors.options] - Error message for options validation
 * 
 * @example
 * const field = {
 *   id: 'new-field',
 ...
 * @returns {Object} Initial field state object
 * @returns {string} id - Empty string for field ID
 * @returns {string} label - Empty string for field label
 * @returns {string} type - Default type 'text'
 * @returns {Array} options - Empty array for select options
 * @returns {string} _rawOptionsText - Empty string for raw options text
 * 
 * @example

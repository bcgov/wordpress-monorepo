 ...
 * @returns {Object} API interaction methods
...
export const useMetadataAPI = () => {
     ...
     * @returns {Array} [response.data] - Array of metadata fields if successful
     * @returns {string} [response.error] - Error message if unsuccessful
     */
